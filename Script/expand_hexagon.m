function expand_hexagon(img_name,path_name)
    ...
    I_sub = datamat.I_sub;
    I_bg = datamat.I_bg;
    brightness = datamat.brightness;
    I_circle = datamat.I_circle;
    grid_size = datamat.grid_size;
    x0 = datamat.x0;
    y0 = datamat.y0;
    xy_idx = datamat.xy_idx;
    xy_pos = datamat.xy_pos;
    parent_idx = datamat.parent_idx;
    %% Scan
    % tested set:
    ...
    %                hold off;
        ...
        save([foldername '/dat_probmap' num2str(nextcell)],'xy_idx','xy_pos','xymap','score','brightness','grid_size','parent_idx');
        % Update figures:
        hold off;
        ...
        title([num2str(size(xy_pos,1)) ' ommatidia detected']);
        drawnow;
    end
