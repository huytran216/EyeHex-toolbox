function varargout=msgbox_img(varargin)
%MSGBOX Message box.
...
inputStr = varargin{1};
BodyTextString = {}; BodyTextString{1}=(inputStr);
...
MsgOff=7; % Margin size
IconWidth = 320 * 72/get(groot,'ScreenPixelsPerInch');
IconHeight = 426 * 72/get(groot,'ScreenPixelsPerInch');

FigWidth = IconHeight + 2*MsgOff;
MsgTxtWidth = FigWidth-2*MsgOff-IconWidth;

FigHeight=IconHeight + 2*MsgOff+ 100;
